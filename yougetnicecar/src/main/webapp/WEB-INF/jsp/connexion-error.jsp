...
<jsp:include page="navbar.jsp" />
	<div style="background-color: rgb(80,80,80);" class="mdl-card mdl-shadow--6dp mdl-cell mdl-cell--middle mdl-cell--4-col">
		<div style="background-color: rgb(60,60,60);" class="mdl-card__title mdl-color-text--white">
	  	...
	  	<div class="mdl-card__supporting-text mdl-cell mdl-cell--middle mdl-cell--8-col">
				<form:form action="/connexion" method="post" modelAttribute="utilisateurConnexionDto">
					...
					<button style="background-color: rgb(50,50,50); color: white; border-radius: 15px;" type="submit" class="mdl-button mdl-button--colored mdl-js-button">SUBMIT</button>
					</div>
				</form:form>
			</div>
		</div>
