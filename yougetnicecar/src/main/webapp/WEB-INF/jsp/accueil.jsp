...
<html>
<style>* { scroll-behavior: smooth !important; }</style>
<head>
    <title>Accueil</title>
</head>
...
<div class="mdl-layout mdl-js-layout">
    ...
    <main class="mdl-layout__content">
		...
		<div style="width: 50%; border: solid white 2px; border-radius: 25px; background-color: rgba(0, 0, 0, 0.5); position: absolute; left: 0; right: 0; margin-left: auto; margin-right: auto; top: 30%;  padding: 25px; text-align: center;">
		    ...
		    <div>
		   		<button style="color: white;" class="mdl-button" onclick="location.href='#about_us'">En Savoir Plus Sur Nous<i style="color: white;" class="mdl-icon-toggle__label material-icons">arrow_downward</i></button>
		    </div>
  		</div>
  		<div>
    ...
    <div class="mdl-mega-footer__left-section">
		...
		<span style="color: white; margin-left: 10px; margin-right: 10px;" class="fa fa-twitter"> Twitter</span></button>
		<button class="mdl-button">
		<span style="color: white; margin-left: 10px; margin-right: 10px;" class="fa fa-instagram"> Instagram</span></button>
		<button class="mdl-button">
		<span style="color: white; margin-left: 10px; margin-right: 10px;" class="fa fa-facebook"> Facebook</span></button>
	</div>
